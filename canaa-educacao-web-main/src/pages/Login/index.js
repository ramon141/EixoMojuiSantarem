...
//import FotoCanaa from '../../assets/cidade_canaa.jpg';
...
const useStyles = makeStyles((theme) => ({
	...
	image: {
		backgroundImage: 'url(https://www.canaadoscarajas.pa.gov.br/novo/wp-content/uploads/2019/08/LETREIRO-TURISTICO.jpeg)',
...
export default function SignIn() {
	...
	async function handleSubmit(e) {
		...
		try {
			...
			if (roleUser === 'Admin' || roleUser === 'Monitor' || roleUser === 'Técnico') {
							...
							<Grid container>
								<Grid item style={{ 'textAlign': 'left', 'marginTop': '10px' }}>
									<p>Problemas para realizar login? Entre em contato com o administrador
										do sistema através do e-mail <b>projetocanaaufpa@gmail.com</b>.</p>
								</Grid>
							</Grid>
